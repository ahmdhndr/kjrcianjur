    ...
    <article className="card rounded-xl overflow-hidden p-5 relative text-gray-300 bg-white shadow-sm">
      <div className="article-thumbs flex justify-end p-5">
        ...
        <div className="ml-3 rounded-tr-40px rounded-bl-25px overflow-hidden sm:h-64 relative">
          {/* <div className="block w-80 h-60 object-cover object-center transform scale-100 hover:scale-110 transition duration-100 ease-linear bg-gray-600">
            <Image
              src={article.imgCover ? article.imgCover : '/images/default.jpg'}
              alt={article.title}
              layout="responsive"
              width={800}
              height={600}
