export default function Hero({ imgSrc, imgAlt, heroTitle, heroSubTitle, objPos, mTop, addCn }) {
  return (
    <section className={`hero relative flex mt-12 overflow-hidden ${addCn}`}>
      ...
      <div
        className={`absolute top-0 left-0 flex flex-col items-center justify-center min-h-full ${
